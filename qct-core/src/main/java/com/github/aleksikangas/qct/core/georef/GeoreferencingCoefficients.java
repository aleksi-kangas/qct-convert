...
public record GeoreferencingCoefficients(double eas,
  ...
  public static final class Parser extends AbstractParser<GeoreferencingCoefficients> {
    @Override
    ...
    @Override
    public GeoreferencingCoefficients parse(final AsynchronousFileChannel asyncFileChannel,
                                            final long byteOffset,
                                            final ParserRegistry parserRegistry) {
      final double[] easDoubles = QctReader.readDoubles(asyncFileChannel, byteOffset, 10);
      final double[] norDoubles = QctReader.readDoubles(asyncFileChannel, byteOffset + 0x50L, 10);
      final double[] latDoubles = QctReader.readDoubles(asyncFileChannel, byteOffset + 0xA0L, 10);
      final double[] lonDoubles = QctReader.readDoubles(asyncFileChannel, byteOffset + 0xF0L, 10);
