...
int main(const int argc, char** argv) {
  ...
  app.add_flag("--no-overwrite", no_overwrite, "Do not overwrite existing files");
  ...
  if (exists(qct_file_path)) {
    if (is_regular_file(qct_file_path)) {
      ...
      try {
        ...
        qct::ex::GeoTiffExportOptions geotiff_export_options{geotiff_export_path, !no_overwrite, geotiff_georef_method};
        qct::ex::KmlExportOptions kml_export_options{kml_export_path, !no_overwrite};
        qct::ex::PngExportOptions png_export_options{png_export_path, !no_overwrite};
